...
{
    RUN_TEST_CASE(observer_unsubscribe_with_state_arg, GivenMockFun1SubscribedWhenUnsubThenTableIsEmpty);
    ...
    /* SUBSCRIBE RET VALUE test cases to run */
    RUN_TEST_CASE(observer_unsubscribe_with_state_arg, GivenMocFun1FuncionSubscribedWhenUnsubscribeStateChangeMockFun1FromSubscriptionTableWitnNonZeroLenghtThenRetValueIsEqualToCalbbackSubscrOk);
    RUN_TEST_CASE(observer_unsubscribe_with_state_arg, GivenMocFun1FuncionSubscribedWhenUnsubscribeStateChangeMockFun1FromSubscriptionTableWitZeroLenghtThenRetValueIsEqualToCalbbackSubscrErrorInvalidArgument);
    ...
    RUN_TEST_CASE(observer_unsubscribe_with_state_arg, GivenMocFun1FuncionSubscribedWhenUnsubscribeStateChangeMockFun1FromNullPtrSubscrTableWitnNonZeroLenghtThenRetValueIsEqualToCalbbackSubscrErrorInvalidArgument);
