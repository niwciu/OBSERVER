...
TEST_GROUP_RUNNER(observer_unsubscribe)
{
    ...
    /* SUBSCRIBE RET VALUE test cases to run */
    RUN_TEST_CASE(observer_unsubscribe, GivenMocFun1FuncionSubscribedWhenUnsubscribeMockFun1FromSubscriptionTableWitnNonZeroLenghtThenRetValueIsEqualToCalbbackSubscrOk);
...
TEST_GROUP_RUNNER(observer_unsubscribe_with_state_arg)
{
    ...
    /* SUBSCRIBE RET VALUE test cases to run */
    RUN_TEST_CASE(observer_unsubscribe_with_state_arg, GivenMocFun1FuncionSubscribedWhenUnsubscribeStateChangeDummyCbFromSubscriptionTableWitnNonZeroLenghtThenRetValueIsEqualToCalbbackSubscrOk);
