...
TEST(observer_unsubscribe_with_arg,
  ...
  subscribe_with_arg(subscribtion, dummy_cb, SYBSCRIPTION_CALBACKS_TABLE_SIZE);
  unsubscribe_with_arg(subscribtion, dummy_cb,
...
TEST(observer_unsubscribe_with_arg,
  ...
  for (int i = 0; i < 5; i++) {
    subscribe_with_arg(subscribtion, (&dummy_cb + (FUN_ADR_OFFSET * i)),
                       SYBSCRIPTION_CALBACKS_TABLE_SIZE);
  }

  unsubscribe_with_arg(subscribtion, (&dummy_cb + (FUN_ADR_OFFSET * 2)),
                       SYBSCRIPTION_CALBACKS_TABLE_SIZE);
...
TEST(observer_unsubscribe_with_arg,
  ...
  unsubscribe_with_arg(subscribtion, (&dummy_cb + (FUN_ADR_OFFSET * 4)),
                       SYBSCRIPTION_CALBACKS_TABLE_SIZE);
...
TEST(observer_unsubscribe_with_arg,
  ...
  unsubscribe_with_arg(subscribtion, unsubscr_fun,
                       SYBSCRIPTION_CALBACKS_TABLE_SIZE);
...
TEST(observer_unsubscribe_with_arg,
  ...
  for (uint8_t i = 0; i < SYBSCRIPTION_CALBACKS_TABLE_SIZE - 1; i++) {
    subscribe_with_arg(subscribtion, dummy_cb,
                       SYBSCRIPTION_CALBACKS_TABLE_SIZE);
  }
