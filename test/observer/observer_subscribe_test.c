...
TEST_TEAR_DOWN(observer_subscribe) { /* Cleanup after every test */ }
...
TEST(
  ...
  static observer_cb_t expexted_subscription[SYBSCRIPTION_CALBACKS_TABLE_SIZE] =
      {NULL};
  ...
  // Then
  TEST_ASSERT_EQUAL_MEMORY_ARRAY(expexted_subscription, subscribtion,
                                 memory_obj_byte_len,
